---
description: 使用這些設定，可將呼叫 Experience Cloud ID 服務使用的預設網域名稱變更為您擁有的子網域名稱。
keywords: ID 服務
seo-description: 使用這些設定，可將呼叫 Experience Cloud ID 服務使用的預設網域名稱變更為您擁有的子網域名稱。
...
使用這些設定，可將呼叫 Experience Cloud ID 服務使用的預設網域名稱變更為您擁有的子網域名稱。
