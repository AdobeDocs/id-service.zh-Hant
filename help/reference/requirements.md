---
description: 請參閱本節，確定您使用的解決方案、服務及程式碼版本是 Experience Cloud ID 服務所要求的正確版本。
keywords: ID 服務
seo-description: 請參閱本節，確定您使用的解決方案、服務及程式碼版本是 Experience Cloud ID 服務所要求的正確版本。
...
請參閱本節，確定您使用的解決方案、服務及程式碼版本是 Experience Cloud ID 服務所要求的正確版本。
