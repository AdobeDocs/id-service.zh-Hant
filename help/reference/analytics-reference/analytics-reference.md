...
+ [Experience Platform Identity Service移轉決策點](migration-decisions.md)
+ [Experience Platform Identity Service移轉案例](migration-scenarios.md)
+ [Analytics 與 Experience Cloud ID 請求](legacy-analytics.md)
+ [資料收集 CNAME 和跨網域追蹤](cname.md)
