---
description: Experience Cloud ID 服務會取代舊有的 Analytics 訪客 ID 方法。
keywords: ID 服務
seo-description: Experience Cloud ID 服務會取代舊有的 Analytics 訪客 ID 方法。
...
Experience Cloud ID 服務會取代舊有的 Analytics 訪客 ID 方法。
