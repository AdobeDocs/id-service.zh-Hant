...
如需詳細資訊，請參閱 [透過Experience Platform Identity Service取得使用者ID和地區](https://marketing.adobe.com/resources/help/en_US/aam/dcs-mcid-ids.html)。
...
您也可以利用 ID 服務提供的 `GET` 方法取得地區 ID。請參閱 [取得地區ID(位置提示)](../library/get-set/getlocationhint.md#reference-a761030ff06c4439946bb56febf42d4c)。
