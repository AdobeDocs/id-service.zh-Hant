---
description: 適用於 Experience Cloud 身分識別服務的標準及非標準實作指示與程式碼範例。
keywords: ID 服務
...
適用於 Experience Cloud 身分識別服務的標準及非標準實作指示與程式碼範例。
...
* [實作適用於 Target 的 Experience Cloud 身分識別服務](setup-target.md)
* [實作適用於 Analytics 和 Audience Manager 的 Experience Cloud 身分識別服務](setup-aam-analytics.md)
* [實作適用於 Analytics、Audience Manager 和 Target 的 Experience Cloud 身分識別服務](setup-aam-analytics-target.md)
* [將 Experience Cloud 身分識別服務用於 A4T 以及伺服器端的 Target 實作](ecid-a4t-target.md)
* [與 Experience Cloud 身分識別服務直接整合](direct-integration.md)
