...
如需詳細資訊，請參閱[透過 Experience Cloud ID 服務取得使用者 ID 與地區](https://marketing.adobe.com/resources/help/zh_TW/aam/dcs-mcid-ids.html)。

如果您是 [!DNL Audience Manager] 客戶，您可從資料收集伺服器 (DCS) 傳送的回應中取得地區 ID。請參閱[從 DCS 回應取得使用者 ID 與地區](https://marketing.adobe.com/resources/help/zh_TW/aam/dcs-aam-ids.html)。

您也可以利用 ID 服務提供的 `GET` 方法取得地區 ID。請參閱[取得地區 ID (位置提示)](../mcvid-library/mcvid-get-set/mcvid-getlocationhint.md#reference-a761030ff06c4439946bb56febf42d4c)。
